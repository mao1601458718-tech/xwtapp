<template>
	<view class="pageView" :style="'padding: '+statusBarHeight+'rpx 0 0 0 ;'">
		...
		<view class="viewTop2">
			<view class="viewTab " :class="swiperCurrent==0?'onViewTab':''" @click="changePage(0)">全部检测项</view>
			<view class="viewTab" :class="swiperCurrent==1?'onViewTab':''" @click="changePage(1)">合格</view>
			<view class="viewTab" :class="swiperCurrent==2?'onViewTab':''" @click="changePage(2)">不合格</view>
...
<script>
	import checkListAll from "../facilityCheck/checkFhListAll.vue"
	import checkListOk from "../facilityCheck/checkListOk.vue"
	import checkListFail from "../facilityCheck/checkListFail.vue"
	export default {
		components: {
			checkListAll,
			checkListFail,
