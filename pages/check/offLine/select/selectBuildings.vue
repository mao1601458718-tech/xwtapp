	...
	export default {
		...
		methods: {
			...
			getFindBybuilding() {
				...
				if (getStorage && getStorage.projectBuildingList) {
					this.buildingDataList = getStorage.projectBuildingList;
				}
				if (getStorage && getStorage.projectBuildingFloorList) {
					getStorage.projectBuildingFloorList.forEach((item) => {
