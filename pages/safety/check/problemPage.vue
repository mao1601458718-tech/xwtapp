		...
		<view class="contentView" v-show="!updateOrAdd">
			<u--form :model="dataForm" :rules="rules" ref="uForm">
				...
				<u-form-item label="问题详情" prop="problem" borderBottom required labelWidth="120">
					<u--textarea v-model="dataForm.problem" placeholder="请描述问题详情" height="120rpx"
				...
				<u-form-item label="对策与措施" prop="countermeasure" borderBottom labelWidth="120">
					<u--textarea v-model="dataForm.countermeasure" placeholder="请描述对策与措施" height="120rpx"
						:adjustPosition="false" :confirmType="null" :maxlength="-1"></u--textarea>
				</u-form-item>

				<u-form-item label="检测依据" prop="inspectionBasis" borderBottom labelWidth="120">
					<u--textarea v-model="dataForm.inspectionBasis" placeholder="请描述检测依据" height="120rpx"
						:adjustPosition="false" :confirmType="null" :maxlength="-1"></u--textarea>
				</u-form-item>

				<u-form-item label="风险可能产生的后果" prop="aftermath" borderBottom required labelWidth="120">
					<u--textarea v-model="dataForm.aftermath" placeholder="请描述风险可能产生的后果" height="120rpx"
						:adjustPosition="false" :confirmType="null" :maxlength="-1"></u--textarea>
				</u-form-item>

				<u-form-item label="所在位置" prop="address" borderBottom required labelWidth="120">
					<u--input v-model="dataForm.address" type="number" border="none" placeholder="请输入所在位置"
...
<script>
	...
	export default {
		...
		onLoad(data) {
			...
			this.dataForm.deviceSysId = info.deviceSysId;
			this.dataForm.safetyType = info.deviceType;
			this.dataForm.deviceCheckItemId = info.deviceCheckItemId;
